...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("lightSources[0].position", 10.0f, 0.0f, 3.0f);
	m_pShaderManager->setVec3Value("lightSources[0].ambientColor", 0.0f, 0.14f, 1.0f);
	...
	m_pShaderManager->setVec3Value("lightSources[2].position", 0.0f, -1.5f, 0.0f);
	m_pShaderManager->setVec3Value("lightSources[2].ambientColor", 0.96f, 0.2f, 0.14f);
	...
	m_pShaderManager->setVec3Value("lightSources[2].position", 4.0f, 1.5f, -4.0f);
	m_pShaderManager->setVec3Value("lightSources[2].ambientColor", 0.96f, 0.2f, 0.14f);
	m_pShaderManager->setVec3Value("lightSources[2].diffuseColor", 0.8f, 0.8f, 0.8f);
	m_pShaderManager->setVec3Value("lightSources[2].specularColor", 0.2f, 0.2f, 0.2f);
	m_pShaderManager->setFloatValue("lightSources[2].focalStrength", 64.0f);
